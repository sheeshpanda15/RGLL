...
N=2500
modeltype="N.ori"
result = Comp(N,p=50,R_all,Var.e=9,nloop=1,n=100,dist_x =filename, dist_a=modeltype,groupsize="large",obj.c=0.1)

result_RS = Comp_RS(N,p=50,R_all,Var.e=9,nloop=1,n=100,dist_x =filename, dist_a=modeltype,groupsize="large",obj.c=0.1)
