...
# Example (deliberately NOT run automatically):
 ...
 result_RS <- Comp_RS(
   N_all = 2500, p = 50, R = 20, Var.e = 9,
   nloop = 50, dist_x = "case1", dist_a = "N.ori",
   groupsize = "large", lambda = 1, Var.b = 0.1
 )
